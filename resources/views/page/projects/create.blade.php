    ...
    <div class="container">
        ...
        <form action="{{route('projects.store')}}" method="post">
            ...
            <div class="form-group" style="margin-bottom: 10px">
                ...
                <input name="duration" type="text" class="form-control" value="{{old('duration')}}" id="duration"
            ...
            <div class="form-group" style="margin-bottom: 10px">
                ...
                <input name="revenue" type="text" class="form-control" value="{{old('revenue')}}" id="revenue"
