...
class ProjectRoleController extends Controller
{
    public function index(){
       ...
       return view('content.manager.managerProjectRole.index',
    ...
    public function add(){
       ...
       return view('content.manager.managerProjectRole.create',
    ...
    public function store(Request $request){
        ...
        return redirect()->route('projectRole');
    }
    public function edit($id){
        ...
        return view('content.manager.managerProjectRole.edit',
